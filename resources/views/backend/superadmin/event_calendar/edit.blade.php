<form method="POST" class="d-block ajaxForm" action="{{ route('event_calendar.update', $event->id) }}">
        ...
        <div class="form-group col-md-12">
            ...
            <small id="title" class="form-text text-muted">Provide Event Title.</small>
        </div>
        ...
        <div class="form-group col-md-12">
            <label for="ending_date">Event Ending Date</label>
        ...
        <div class="form-group  col-md-12">
            <button class="btn btn-block btn-primary" type="submit">Update Event</button>
        </div>
    </form>
