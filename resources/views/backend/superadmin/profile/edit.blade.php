            ...
            <div class="card-body">
                ...
                <form method="POST" class="col-12 profileAjaxForm" action="{{ route('profile.update', 'profile') }}" id = "profileAjaxForm" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="example-fileinput"> Update User Image</label>
                            <div class="col-md-9">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" class="col-12 changePasswordAjaxForm" action="{{ route('profile.update', 'password') }}" id = "changePasswordAjaxForm" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="name"> Old Password</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="name"> Confirm Password</label>
                            <div class="col-md-9">
