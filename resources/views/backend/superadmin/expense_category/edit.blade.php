<form method="POST" class="d-block ajaxForm" action="{{ route('expense_category.update', $expense_category->id) }}">
    ...
    <div class="form-group col-md-12">
        ...
        <small id="name_help" class="form-text text-muted">Provide Expense Category Name.</small>
    </div>

    <div class="form-group  col-md-12">
        <button class="btn btn-block btn-primary" type="submit">Update Expense Category</button>
    </div>
</form>
...
<script>
    ...
    $(".ajaxForm").submit(function(e) {
        var form = $(this);
        ajaxSubmit(e, form, 'expense_category_content');
    });
</script>
