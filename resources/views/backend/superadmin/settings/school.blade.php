                    ...
                    <form method="POST" class="col-12 schoolForm" action="{{ route('school.update', $school_data->id) }}" id = "schoolForm">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="address" name="address" class="form-control"  value="{{ $school_data->address }}" required>
                                </div>
                            </div>
                            
                            <div class="text-center">
                                <button type="submit" class="btn btn-secondary col-xl-4 col-lg-4 col-md-12 col-sm-12" onclick="updateSchoolInfo()">{{ translate('update_school_settings') }}</button>
                            </div>
                        </div>
                    </form>
