                ...
                <form method="POST" class="col-12 systemAjaxForm" action="{{ route('system.update') }}" id = "system_settings">
                    ...
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-secondary col-xl-8 col-lg-12 col-md-12 col-sm-12" onclick="updateSystemInfo($('#system_name').val())">{{ translate('update_system_settings') }}</button>
                        </div>
                    </div>
                </form>
            ...
            <div class="card-body">
                ...
                <form method="POST" class="col-12 systemLogoAjaxForm" action="{{ route('logo.update') }}" id = "system_settings" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-secondary col-xl-8 col-lg-12 col-md-12 col-sm-12" onclick="updateSystemLogo()">{{ translate('update_system_settings') }}</button>
                        </div>
                    </div>
                </form>     
            </div> <!-- end card body-->
