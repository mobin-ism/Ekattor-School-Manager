        ...
        <tr>
            ...
            <td>
                <div class="btn-group mb-2">
                    <button type="button" class="btn btn-icon btn-warning" style="margin-right:5px;" onclick="showAjaxModal('{{ route('department.edit', $department->id) }}')"> <i class="mdi mdi-wrench"></i> </button>
