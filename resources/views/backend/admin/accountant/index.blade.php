...
@section('content')
    ...
    <div class="row ">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-icon btn-success" style="float: right;" onclick="showAjaxModal('{{ route('accountant.create') }}')"> <i class="mdi mdi-plus"></i> Add New Accountant</button>
